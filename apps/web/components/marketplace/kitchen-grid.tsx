...
export default function KitchenGrid({
  ...
  if (kitchens.length === 0) {
    return (
      <div className="py-20 text-center rounded-[26px] border border-hairline bg-white shadow-card">
        ...
        <p className="font-semibold text-surface-900">No kitchens found</p>
